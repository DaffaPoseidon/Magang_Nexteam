...
<Modal isPromo={true} showModal={showModal} on:click={toggleModal}>
	<!-- Slot bernama, yakni agar tidak langsung dicetak ke web dalam tag <slot> biasa di class asal, yakni Modal.svelte -->
	<div slot="title">
		<h3>Add a New Person</h3>
	</div>
	<!-- Form untuk menambahkan person ke loop? -->
	<form>
		<input type="text" placeholder="name">
		<input type="text" placeholder="character color">
...
<main>
	...
	<!-- Button untuk menyimpan function toggleModal sekaligus modalnya di web -->
